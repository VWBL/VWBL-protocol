...
class LazyMinter {
  ...
  async createVoucher(minter, documentId, randomString, uri, royaltiesPercentage, sellPrice = 0) {
    const voucher = { minter, documentId, randomString, sellPrice, uri, royaltiesPercentage};

...
interface IStableCoinFeeRegistry {
     ...
     */
    function registerStableCoinInfo(string memory _fiatName, address[] memory _erc20Addresses, uint _feeNumerator) external;
     ...
     */
    function registerFeeNumerator(uint fiatIndex, uint newFeeNumerator) external;
     ...
     */
    function renameFiat(uint fiatIndex, string memory newFiatName) external;
     ...
     */
    function registerERC20Addresses(uint fiatIndex, address[] memory newERC20Addresses) external;
     ...
     */
    function unregisterERC20Address(uint fiatIndex, address erc20Address) external;

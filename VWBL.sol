...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/contracts/token/ERC721/extensions/IERC721Metadata.sol";
 ...
 * {ERC721Enumerable}.
 */
contract VWBLProtocol is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = VWBLProtocol.ownerOf(tokenId);
    ...
    function getEncryptedDecryptKey(uint256 tokenId) public view returns(string memory) {
        require(VWBLProtocol.ownerOf(tokenId) == msg.sender, "ERC721: cannot see key of token that is not own");
    ...
    function _transfer(
        ...
        require(VWBLProtocol.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(VWBLProtocol.ownerOf(tokenId), to, tokenId);
    }
...
contract VWBL is VWBLProtocol, Ownable{
    ...
    constructor(string memory _baseURI) public VWBLProtocol("VWBL", "VWBL") {
        baseURI = _baseURI;
    }
